...
import { AssignmentSteps } from "@/components/products/AssignmentSteps"
import { AssignmentSummary } from "@/components/products/AssignmentSummary"
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink asChild>
              <Link href={`/protected/operations-dashboard/products/${productId}`}>{product.name}</Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Assign</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
